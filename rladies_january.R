...
[RLadies Freiburg] Best of 2021: Data Wrangling with the tidyverse and
[RLadies Remote] RLadies Remote Coffee Chat Jan 2022"
events[28] <- "28 - [RLadies Chennai] Data analysis using the dplyr package and
[RLadies Gainesville] Creating and sharing R tutorials"
events[31] <- "31 - [RLadies Remote] R Package Development Workshop Series and
[RLadies East Lansing] Accessible DataViz"

# Creating the calendar
png(file = "rladies_calendar_jan2022_v3.png", width = 1024, height = 768)
...
[RLadies Urmia] Book Club R4DS and
[RLadies Freiburg] Best of 2021: Data Wrangling with the tidyverse and
[RLadies Remote] RLadies Remote Coffee Chat Jan 2022"="plum3",
                                   "28 - [RLadies Chennai] Data analysis using the dplyr package and
[RLadies Gainesville] Creating and sharing R tutorials"="purple",
                                   "31 - [RLadies Remote] R Package Development Workshop Series and
